...
def update_progress_bar(iteration, loss, variation, time):
    ...
    sys.stdout.write('\rLearning : \033[96m{}\033[0m | Loss : {}\033[0m | Variation : \033[93m{:.15f}\033[0m  | Time : \033[94m{}\033[0m'.format(str(iteration).zfill(13), color + str(round(loss, 14)), variation, time))
    sys.stdout.flush()